...
class JobPost2 extends React.Component {
  render() {
    return (
      <div class="wrapper">
        <Header>
                ...
                <div class="col-md-8 col-md-offset-2">
                  ...
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      ></textarea>
                      <small class="color-white-mute">
                        Formatting Options: ##heading *bold* _italic_ * bulleted
                        list
                      </small>
                    </div>
                    <div class="form-group">
                    ...
                    <p>
                      Applications will be emailed to:{" "}
