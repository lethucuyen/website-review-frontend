                      ...
                      <div class="item">
                        <div class="row">
                          ...
                          <div class="col-md-11">
                            ...
                            <h5>
                              <span class="color-black">CollegeHumor</span> -{" "}
                              <span class="color-white-mute">
                                New York, NY 10011 (Chelsea area)
                              </span>
                            </h5>
                            <p class="text-truncate ">
                              Back-end development experience in PHP 5, and a
                              strong understanding of Object Oriented
                              Programming within an MVC framework
                            </p>
                            <div>
                      ...
                      <div class="item">
                        <div class="row">
                          <div class="col-md-1 hidden-sm hidden-xs">
                            <div class="img-item">
                              <img
                                src="./assets/theme/images/company-logo/2.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          <div class="col-md-11">
                            ...
                            <h5>
                              ...
                              - <span class="color-white-mute">Austin, TX</span>
                            </h5>
                            <p class="text-truncate ">
                              Experience in an environment using a programming
                              language such as PHP. To build and maintain
                              websites for the College of Fine Arts
                            </p>
                            <div>
                      ...
                      <div class="item">
                        <div class="row">
                          <div class="col-md-1 hidden-sm hidden-xs">
                            <div class="img-item">
                              <img
                                src="./assets/theme/images/company-logo/3.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          <div class="col-md-11">
                            ...
                            <h5>
                              <span class="color-black">Krossover</span> -{" "}
                              <span class="color-white-mute">
                                New York, NY 10011 (Chelsea area)
                              </span>
                            </h5>
                            <p class="text-truncate ">
                              {" "}
                              PHP and/or Java. Architect features with the
                              development team. Krossover is looking for a Web
                      ...
                      <div class="item">
                        <div class="row">
                          <div class="col-md-1 hidden-sm hidden-xs">
                            <div class="img-item">
                              <img
                                src="./assets/theme/images/company-logo/4.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          <div class="col-md-11">
                            ...
                            <h5>
                              <span class="color-black">Tektronix </span> -{" "}
                              <span class="color-white-mute">
                                Beaverton, OR
                              </span>
                            </h5>
                            <p class="text-truncate ">
                              Experience with PHP, Python, Perl, Ruby, Node.js,
                              REST. Entry Level - Software Engineer.
                            </p>
                            <div>
                      ...
                      <div class="item">
                        <div class="row">
                          <div class="col-md-1 hidden-sm hidden-xs">
                            <div class="img-item">
                              <img
                                src="./assets/theme/images/company-logo/5.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          <div class="col-md-11">
                            ...
                            <h5>
                              <span class="color-black">Shutterstock </span>
                              <span class="rate">
